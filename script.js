...
const getRandomNumber = (num) => {return Math.floor(Math.random() * (num + 1));};
  ...
  noButton.addEventListener("click", () => {
    ...
    if (noClickCount < 4) {
      ...
      //no button text
      const messages = ["No","Aisa kyu?","SUGAR DIDI KO DEKHO?","Aise nhi hota :(","Say yes or else...",];
  ...
  yesButton.addEventListener("click", () => {
    ...
    valentineQuestion.innerHTML = `
      ...
      Congratulations!!<br>
      <span style="font-size: 20px; color: #bd1e59;">YAYAYAYAYA I LOVE YOU PRINCESS! <3</span>
    `;
